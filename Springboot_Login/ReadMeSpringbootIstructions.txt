***Istruzioni per implementazione SPRINGBOOT:***
...
INSERT INTO `user` (`id`, `password`, `username`, `email`, `enabled`) VALUES
(11, '$2a$10$vjhvpPAbI3RPYy7Z8NEp7uThwcM7usT7LbhZrHvPHPhb0AMzafmUG', 'admin', 'antosveglio@gmail.com', 1),
(1, 'root', 'marioRossi', 'mariorossi@root.com', 1),
(10, '$2a$10$9SWWHyk0nxPUmc8AxUokVe0r1He3jVEICF7MhomL9djjfZPQvswzG', 'user', 'user@info.it', 1);
...
(3);
	...
	2-Aprire con IntelliJ la cartella del progetto di springboot e verificare il seguente file presente nel package "resources"
		...
		verificare se la porta e il nome del database coincide con il proprio database
...
spring.datasource.driver-class-name=com.mysql.cj.jdbc.Driver
	...
	3-Avvio programma: sotto il "service", cliccare su UtentiApplication:
		cliccare su "run"(tastino play) affianco al codice public class UtentiApplication {....etc.}

	
	4-Verificare gli eventuali errori, se il programma funziona la console come ultima riga deve mostrare la seguente scritta:
